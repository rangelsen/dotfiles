...
vim.keymap.set('n', '<leader>so', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
vim.keymap.set('n', '<leader>sh', require('telescope.builtin').help_tags, { desc = '[S]earch [H]elp' })
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', '<leader>si', require('telescope.builtin').live_grep, { desc = '[S]earch by [G]rep' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'c_sharp', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'haskell' },
...
vim.keymap.set('i', '<C-a>', 'copilot#Accept("")',
  { noremap = true, expr = true, silent = true, replace_keycodes = false, desc = "Copilot: Accept suggestion." })
...
vim.keymap.set('i', '<C-s>', '<Plug>(copilot-suggest)', { desc = "Copilot: Request suggestion." })
vim.keymap.set('i', '<C-->', '<Plug>(copilot-dismiss)', { desc = "Copilot: Dismiss suggestion." })
vim.keymap.set('i', '<C-o>', '<Cmd>Copilot panel<CR>', { desc = "Copilot: Open suggestion panel." })
